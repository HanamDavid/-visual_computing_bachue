    ...
    constructor(o, a) {
      super(),
        ...
        (this.listenToKeyEvents = function (e) {
          e.addEventListener("keydown", X), (this._domElementKeyEvents = e);
        }),
        ...
        (this.update = (function () {
          ...
          return function () {
            ...
            t.copy(o).sub(i.target),
              ...
              i.autoRotate &&
                s === c.NONE &&
                v(((2 * Math.PI) / 60 / 60) * i.autoRotateSpeed),
              i.enableDamping
            ...
            return (
              isFinite(T) &&
                ...
                f < -Math.PI ? (f += b) : f > Math.PI && (f -= b),
                (u.theta =
                  T <= f
                    ? Math.max(T, Math.min(f, u.theta))
                    : u.theta > (T + f) / 2
                    ? Math.max(T, u.theta)
                    : Math.min(f, u.theta))),
              (u.phi = Math.max(
                i.minPolarAngle,
                Math.min(i.maxPolarAngle, u.phi)
              )),
              u.makeSafe(),
              (u.radius *= m),
              (u.radius = Math.max(
                i.minDistance,
                Math.min(i.maxDistance, u.radius)
              )),
              !0 === i.enableDamping
              ...
              !!(
                E ||
                p.distanceToSquared(i.object.position) > r ||
                8 * (1 - d.dot(i.object.quaternion)) > r
              ) &&
                (i.dispatchEvent(e),
        ...
        (this.dispose = function () {
          i.domElement.removeEventListener("contextmenu", B),
            ...
            i.domElement.removeEventListener("touchstart", F),
            i.domElement.removeEventListener("touchend", K),
            i.domElement.removeEventListener("touchmove", Z),
            i.domElement.ownerDocument.removeEventListener("pointermove", _),
            i.domElement.ownerDocument.removeEventListener("pointerup", z),
            null !== i._domElementKeyEvents &&
              i._domElementKeyEvents.removeEventListener("keydown", X);
        });
      const i = this,
        c = {
          NONE: -1,
          ...
          return function (t, n) {
            ...
            if (i.object.isPerspectiveCamera) {
              ...
              (c *= Math.tan(((i.object.fov / 2) * Math.PI) / 180)),
                w((2 * t * c) / o.clientHeight, i.object.matrix),
                A((2 * n * c) / o.clientHeight, i.object.matrix);
            } else
      ...
      function C(e) {
        ...
        b.subVectors(d, p).multiplyScalar(i.rotateSpeed);
        const t = i.domElement;
        v((2 * Math.PI * b.x) / t.clientHeight),
      ...
      function x(e) {
        ...
        O.subVectors(f, T).multiplyScalar(i.panSpeed), L(O.x, O.y), T.copy(f);
      }
      function U(e) {
        const t = e.touches[0].pageX - e.touches[1].pageX,
          n = e.touches[0].pageY - e.touches[1].pageY,
          ...
          switch (e.pointerType) {
            ...
            case "pen":
              !(function (e) {
                ...
                s !== c.NONE &&
                  (i.domElement.ownerDocument.addEventListener(
                    "pointermove",
                    _
                  ),
                  i.domElement.ownerDocument.addEventListener("pointerup", z),
                  i.dispatchEvent(t));
              })(e);
          }
      }
                  ...
                  case c.PAN:
                    ...
                    !(function (e) {
                      f.set(e.clientX, e.clientY),
                        O.subVectors(f, T).multiplyScalar(i.panSpeed),
                        L(O.x, O.y),
                        T.copy(f),
                        i.update();
                    })(e);
      ...
      function I(e) {
        !1 === i.enabled ||
          ...
          i.dispatchEvent(t),
          (function (e) {
            e.deltaY < 0 ? M(y()) : e.deltaY > 0 && N(y()), i.update();
          })(e),
          i.dispatchEvent(n));
      }
      function X(e) {
        !1 !== i.enabled &&
          ...
          (function (e) {
            ...
            switch (e.code) {
              case i.keys.UP:
                L(0, i.keyPanSpeed), (t = !0);
                break;
              case i.keys.BOTTOM:
                L(0, -i.keyPanSpeed), (t = !0);
                break;
              case i.keys.LEFT:
                L(i.keyPanSpeed, 0), (t = !0);
                break;
              case i.keys.RIGHT:
                L(-i.keyPanSpeed, 0), (t = !0);
            }
            ...
            case 2:
              switch (i.touches.TWO) {
                case THREE.TOUCH.DOLLY_PAN:
                  ...
                  !(function (e) {
                    i.enableZoom && k(e), i.enablePan && Y(e);
                  })(e),
                    (s = c.TOUCH_DOLLY_PAN);
                  break;
                case THREE.TOUCH.DOLLY_ROTATE:
                  ...
                  !(function (e) {
                    i.enableZoom && k(e), i.enableRotate && S(e);
                  })(e),
                    (s = c.TOUCH_DOLLY_ROTATE);
                  break;
                default:
                  s = c.NONE;
              }
        ...
        if (!1 !== i.enabled)
          switch ((e.preventDefault(), s)) {
            ...
            case c.TOUCH_DOLLY_PAN:
              if (!1 === i.enableZoom && !1 === i.enablePan) return;
              !(function (e) {
                i.enableZoom && U(e), i.enablePan && x(e);
              })(e),
                i.update();
              break;
            case c.TOUCH_DOLLY_ROTATE:
              if (!1 === i.enableZoom && !1 === i.enableRotate) return;
              !(function (e) {
                i.enableZoom && U(e), i.enableRotate && C(e);
              })(e),
                i.update();
              break;
            default:
      ...
      function K(e) {
        !1 !== i.enabled && (i.dispatchEvent(n), (s = c.NONE));
      }
      function B(e) {
        !1 !== i.enabled && e.preventDefault();
      }
      i.domElement.addEventListener("contextmenu", B),
        i.domElement.addEventListener("pointerdown", V),
        i.domElement.addEventListener("wheel", I, { passive: !1 }),
        i.domElement.addEventListener("touchstart", F, { passive: !1 }),
        i.domElement.addEventListener("touchend", K),
        i.domElement.addEventListener("touchmove", Z, { passive: !1 }),
        this.update();
    }
  }
